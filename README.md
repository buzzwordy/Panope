...
```sh
sudo apt install ./panope_3.2.2_amd64.deb     # Debian / Ubuntu
sudo dnf install ./panope-3.2.2.x86_64.rpm    # Fedora / RHEL
chmod +x Panope-3.2.2.AppImage && ./Panope-3.2.2.AppImage
```

Windows: run `Panope-Setup-3.2.2.exe`, or unzip the portable build. macOS
