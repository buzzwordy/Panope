...
```sh
sudo apt install ./panope_3.2.1_amd64.deb     # Debian / Ubuntu
sudo dnf install ./panope-3.2.1.x86_64.rpm    # Fedora / RHEL
chmod +x Panope-3.2.1.AppImage && ./Panope-3.2.1.AppImage
```

Windows: run `Panope-Setup-3.2.1.exe`, or unzip the portable build. macOS
