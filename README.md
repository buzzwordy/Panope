...
```sh
sudo apt install ./panope_3.0.0_amd64.deb     # Debian / Ubuntu
sudo dnf install ./panope-3.0.0.x86_64.rpm    # Fedora / RHEL
chmod +x Panope-3.0.0.AppImage && ./Panope-3.0.0.AppImage
```

Windows: run `Panope-Setup-3.0.0.exe`, or unzip the portable build. macOS
