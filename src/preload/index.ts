...
const api: PanopeApi = {
  ...
  openApiSchemas: (apiVersion) => ipcRenderer.invoke(IPC.openApiSchemas, apiVersion),
  servedApiVersions: () => ipcRenderer.invoke(IPC.servedApiVersions),
  ...
  aiConfirm: (id, approve, alwaysTool) => ipcRenderer.invoke(IPC.aiConfirm, id, approve, alwaysTool),
  ...
  aiMcpStatus: () => ipcRenderer.invoke(IPC.aiMcpStatus),
  ...
  latestK8sPatch: (minor) => ipcRenderer.invoke(IPC.latestK8sPatch, minor),
