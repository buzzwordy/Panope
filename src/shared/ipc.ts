...
export const IPC = {
  ...
  openApiSchemas: 'k8s:openApiSchemas',
  servedApiVersions: 'k8s:servedApiVersions',
  ...
  listKubeconfigs: 'k8s:listKubeconfigs',
  addKubeconfig: 'k8s:addKubeconfig',
  removeKubeconfig: 'k8s:removeKubeconfig',
  browseForKubeconfig: 'k8s:browseForKubeconfig',
  ...
  aiMcpStatus: 'ai:mcpStatus',
  aiGetConfig: 'ai:getConfig',
  aiSetConfig: 'ai:setConfig',
  aiEvent: 'ai:event', // main -> renderer push
  ...
  latestK8sPatch: 'app:latestK8sPatch',
