...
import { loadPrefs, savePrefs, themeBase, type SavedView, type ThemeId } from './lib/prefs'
...
export function App(): React.ReactElement {
  ...
  return (
    <div className={`app-shell${aiOpen && isDesktop ? ' has-assistant' : ''}`} data-density={density}>
      <Sidebar
      ...
      {aiOpen && isDesktop && (
        <AssistantPanel
          uiCtx={{ context: clusterInfo?.context, namespace, view: activeKey }}
